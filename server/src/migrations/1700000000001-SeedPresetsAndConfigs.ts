    ...
    await queryRunner.query(`
      INSERT INTO system_configs (key, value, updated_by) VALUES
        ...
        ('rate_limit',
         ...
         'system'),
        ('ai_models',
         '{"primary":{"vendor":"tongyi","model":"wan2.7-image","enabled":true,"timeoutMs":30000},"secondary":{"vendor":"hunyuan","model":"hunyuan-vision","enabled":true,"timeoutMs":30000},"allowFallback":true}'::jsonb,
         'system'),
        ('prompt_prefix',
